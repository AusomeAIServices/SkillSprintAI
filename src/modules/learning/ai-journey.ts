    ...
    milestones: [
      {
        ...
        topics: [
          { id: "journey-orientation", difficulty: "Easy", title: "What is AI?", explanation: "AI is software that learns patterns from examples to make predictions or create responses. ChatGPT is one AI chat tool: you can ask it questions in everyday language, and it can explain, draft, or organize ideas. Its answers can be wrong, so check important facts.", practice: "Think of a question you would usually type into Google, such as “Why does rain happen?” In the next topic, you will compare a search result with a ChatGPT conversation." },
